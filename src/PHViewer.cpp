...
void PHViewer::loadShaders(const GLchar* vShaderFile, const GLchar* fShaderFile)
{
    ...
    lightPosParam = glGetUniformLocation(program, "lightPos");
    intensityParam = glGetUniformLocation(program, "intensidad");
    indirectIntensityParam = glGetUniformLocation(program, "indirectIntensity");
    normalParam = glGetAttribLocation(program, "normal");
    // --------------------------------------------
...
void PHViewer::loadModel(const char *fileName)
{
    ...
    glVertexAttribPointer(normalParam, 3, GL_FLOAT, GL_FALSE, 0, 0);
...
void PHViewer::draw()
{
    ...
    glUniform3fv(lightPosParam, 1, glm::value_ptr(glm::vec3(0, 0.03, 0))); // en el centro más o menos alto
    glUniform1f(intensityParam, 10);
    glUniform1f(indirectIntensityParam, 2); // hay gran 10/2 para simular la noche
...
int main(int argc, char** argv)
{
    ...
    phViewer.loadShaders(
            "/home/nemo/Escritorio/PR1/Ej2/src/shaders/vpassthrough.glsl",
            "/home/nemo/Escritorio/PR1/Ej2/src/shaders/fpassthrough.glsl"
            );
    phViewer.loadModel(
            "/home/nemo/Escritorio/PR1/Ej2/src/models/malla.obj"
            );
    // --------------------------------------------
